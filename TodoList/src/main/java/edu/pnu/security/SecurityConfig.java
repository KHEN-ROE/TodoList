...
//    }
    ...
    JwtDecoder jwtDecoder() {
    	// 비밀 키 생성
        SecretKey secretKey = Keys.hmacShaKeyFor("your_secretKey".getBytes(StandardCharsets.UTF_8));
